...
public class Ch_4Activity extends AppCompatActivity implements View.OnFocusChangeListener {
        ...
        imageView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                try {
                    ...
                    Log.e(Ch_4Activity.class.toString(), e.toString());
                }
    ...
    class MyClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            Log.i(Ch_4Activity.class.toString(), "button click");
        }
